...
public class Operator
{
    ...
    public string VehicleType { get; set; } = string.Empty; // "Tow truck", "Mechanic", etc.
    ...
    // Navigation property - equipment that the operator possesses (through OperatorEquipment)
